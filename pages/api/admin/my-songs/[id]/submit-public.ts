...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const [personalSong] = await db
    .select({
      ...
      title: songs.title,
      year: songs.year,
      playStartSeconds: songs.playStartSeconds,
      youtubeUrl: songs.youtubeUrl,
      songAttributes: songs.songAttributes,
      isSpanish: songs.isSpanish,
      mimica: songs.mimica,
      tararear: songs.tararear,
      karaoke: songs.karaoke,
      karaokePauseSeconds: songs.karaokePauseSeconds,
      karaokeLyric: songs.karaokeLyric,
      trivia: songs.trivia,
      triviaQuestion: songs.triviaQuestion,
      triviaAnswer: songs.triviaAnswer,
  ...
  await db.insert(songs).values({
    ...
    playStartSeconds: personalSong.playStartSeconds,
    youtubeUrl: personalSong.youtubeUrl,
    songAttributes: personalSong.songAttributes,
    isSpanish: personalSong.isSpanish,
    mimica: personalSong.mimica,
    tararear: personalSong.tararear,
    karaoke: personalSong.karaoke,
    karaokePauseSeconds: personalSong.karaokePauseSeconds,
    karaokeLyric: personalSong.karaokeLyric,
    trivia: personalSong.trivia,
    triviaQuestion: personalSong.triviaQuestion,
    triviaAnswer: personalSong.triviaAnswer,
