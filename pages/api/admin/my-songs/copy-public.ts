...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  await db.insert(songs).values({
    ...
    playStartSeconds: sourceSong.playStartSeconds,
    youtubeUrl: sourceSong.youtubeUrl,
    songAttributes: sourceSong.songAttributes,
    isSpanish: sourceSong.isSpanish,
    mimica: sourceSong.mimica,
    tararear: sourceSong.tararear,
    karaoke: sourceSong.karaoke,
    karaokePauseSeconds: sourceSong.karaokePauseSeconds,
    karaokeLyric: sourceSong.karaokeLyric,
    trivia: sourceSong.trivia,
    triviaQuestion: sourceSong.triviaQuestion,
    triviaAnswer: sourceSong.triviaAnswer,
